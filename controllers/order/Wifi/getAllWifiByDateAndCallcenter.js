...
const getAllWifiByDateAndCallcenter = async (req, res) => {
  try {
    ...
    // Fetch WiFi records matching the provided date, callcenter ID, and fromWhere with pagination
...
module.exports = getAllWifiByDateAndCallcenter;
