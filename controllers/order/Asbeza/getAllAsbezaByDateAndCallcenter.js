...
const getAllAsbezaByDateAndCallcenter = async (req, res) => {
  try {
    ...
    // Fetch Asbeza records matching the provided date, callcenter ID, and fromWhere with pagination
...
module.exports = getAllAsbezaByDateAndCallcenter;
